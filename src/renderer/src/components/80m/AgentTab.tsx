...
const AGENTS: AgentConfig[] = [
  { id: 'prawnius', name: 'Prawnius', color: '#22c55e', icon: 'Bot', role: 'Quick Tasks' },
  { id: 'claudnelius', name: 'Claudnelius', color: '#3b82f6', icon: 'PenTool', role: 'Code & Design' },
  { id: 'knowledge_knaight', name: 'Knowledge', color: '#f59e0b', icon: 'Search', role: 'Research' },
  { id: 'clawdette', name: 'Clawdette', color: '#ef4444', icon: 'CheckCircle2', role: 'Operations' },
];
...
export const AgentTab: React.FC<AgentTabProps> = ({ agent, isActive, isWorking, onClick }) => {
  return (
    <motion.button
