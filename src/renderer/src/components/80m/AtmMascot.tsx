...
interface AtmMascotProps {
  state?: 'default' | 'processing' | 'typing' | 'sleep' | 'error' | 'searching' | 'jackpot' | 'lobster' | 'urgent' | 'job-done';
  isIntro?: boolean;
  className?: string;
}

const AtmMascot: React.FC<AtmMascotProps> = ({ state = 'default', isIntro = false, className = '' }) => {
  return (
    <div
